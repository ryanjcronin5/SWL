...
function createproject($conn, $pName, $pType, $pNote)
{
    $sql = "INSERT INTO projects (projectName, projectType, projectNotes) VALUES  ($pName, $pType, $pNote);";

    if ($result = mysqli_query($conn, $sql)) {
        header("location: ..\..\query.php?error=failed");
        exit();
    }
